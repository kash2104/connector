      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow-lg hover:shadow-xl transition-colors duration-300">
              Create Workspace
            </Button>
          </DialogTrigger>
          <DialogContent className="bg-[#1E293B] border-[#334155] text-white sm:max-w-[425px]">
            ...
            <form onSubmit={handleCreateWorkspace} className="space-y-4 mt-4">
              ...
              <motion.button 
                type="submit" 
                disabled={isCreating} 
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg shadow-lg flex items-center justify-center gap-2 transition-colors duration-300 mx-auto"
          ...
          >
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <Button
                  asChild
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded shadow-lg hover:shadow-xl transition-all duration-300"
                >
