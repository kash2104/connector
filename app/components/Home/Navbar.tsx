      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* <Button variant="ghost" className="text-md font-medium text-gray-300 hover:text-[#38BDF8]">
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Button asChild>
              <Link href="#features" className="block text-md font-medium text-gray-300 hover:text-[#38BDF8] transition-colors">Features</Link>
            </Button>
            <Button asChild>
              <Link href="#how-it-works" className="block text-md font-medium text-gray-300 hover:text-[#38BDF8] transition-colors">How It Works</Link>
            </Button>
            {/* <Button asChild>
              <Link href="/pricing" className="block text-sm font-medium text-gray-300 hover:text-[#38BDF8] transition-colors">Pricing</Link>
            </Button> */}
            <Button asChild variant="outline" size="sm" className="text-[#38BDF8] border-[#38BDF8] hover:bg-[#38BDF8] hover:text-white">
              <Link href="/auth">Get Started</Link>
            </Button>

            {/* <Button className=" bg-[#38BDF8] hover:bg-[#0EA5E9] text-white mt-2">
